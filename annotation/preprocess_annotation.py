...
DFEW_SOURCE = "enter your path"
DFEW_CLIP_SOURCE = os.path.join(DFEW_SOURCE, "Clip", "clip_224x224")

def main():
    all_anno_file = sorted(glob(os.path.join(DFEW_SOURCE, "enter your path", "**", "*.csv")))
    for anno_file in all_anno_file:
        ...
        for index, row in data.iterrows():
            ...
            full_video_name = os.path.join("enter your path", video_name)
